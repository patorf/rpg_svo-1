...
Config::Config() :
    ...
    n_pyr_levels(vk::getParam<int>("svo/n_pyr_levels", 4)),
    ...
    reproj_thresh(vk::getParam<double>("svo/reproj_thresh", 4.0)),
    poseoptim_thresh(vk::getParam<double>("svo/poseoptim_thresh", 4.0)),
